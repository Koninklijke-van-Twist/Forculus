...
<head>
    ...
    <style>
        ...
        .tag-blue {
            ...
            /* verticaal passend in het element */
            background-position: right center;
            /* zo ver mogelijk rechts, verticaal gecentreerd */
            padding-right: 35px;
        }
    ...
    <div class="container">
        ...
        <div class="actions-top">
            <?php if (!empty($sleutels)): ?>
                <input type="text" id="sleutelSearch" placeholder="Zoek in alle kolommen..."
                ...
                <tbody>
                    <?php foreach ($sleutels as $s): ?>
                        ...
                        <tr>
                            ...
                            <td
                                class="nowrap <?php if ($s['tapkey_id'] <> null || $s['toegang'] <> null): ?>above<?php endif; ?>">
